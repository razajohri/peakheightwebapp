...
function AndroidIcon({ className }: { className?: string }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M17.6 9.48l1.84-3.18c.16-.31.04-.69-.26-.85a.637.637 0 0 0-.83.26l-1.88 3.24a11.43 11.43 0 0 0-8.94 0L5.65 5.71a.643.643 0 0 0-.87-.26c-.3.16-.42.54-.26.85l1.84 3.18C4.14 11.07 2.5 13.58 2.5 16.5h19c0-2.92-1.64-5.43-3.9-7.02zM7.5 14.25a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm9 0a1 1 0 1 1 0-2 1 1 0 0 1 0 2z" />
    </svg>
  )
}

function ProgramCtaIcons({ os }: { os: 'ios' | 'android' | 'other' }) {
  if (os === 'android') {
    return <AndroidIcon className={styles.ctaPlatformIcon} />
  }
  if (os === 'ios') {
    return <AppleIcon className={styles.ctaPlatformIcon} />
  }
  return (
    <span className={styles.ctaPlatformPair} aria-hidden>
      <AppleIcon className={styles.ctaPlatformIcon} />
      <AndroidIcon className={styles.ctaPlatformIcon} />
    </span>
  )
}
      ...
      <main>
        ...
        <section className={styles.finalCta}>
          ...
          <p className={styles.finalCtaSubtitle}>
            Download PeakHeight and start your personalized growth program today.
          </p>
          <a
            href={primaryStore}
            target="_blank"
